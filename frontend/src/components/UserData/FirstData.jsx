      ...
      <Grid item container xs={9} spacing={2}>
          ...
          <Grid container item xs={12} sm={12}>
            ...
            <Grid container direction={"column"} item xs={12} sm={12} alignItems={"center"} >
              <Typography sx={{ marginBottom:"20px", fontSize:"20px" }}>Gender</Typography>
              <RadioGroup
            ...
            <Grid container direction={"column"} item xs={12} sm={12} alignItems={"center"}>
              <Typography sx={{ marginBottom:"20px", fontSize:"20px" }}>Show Me</Typography>
              <RadioGroup
                aria-label="platform"
                defaultValue="Website"
                overlay
